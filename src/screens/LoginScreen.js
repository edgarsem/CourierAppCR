    ...
    return(
        ...
        >
            <View style={{
                ...
                <TextInput style={{marginBottom: 40, marginTop: 40, marginLeft: 30, backgroundColor: 'white', width: 200, height: 40}}
                placeholder="Email"
                value={email}
                onChangeText={text => setEmail(text)}
                />
                <TextInput style={{marginBottom: 40, marginLeft: 30, marginLeft: 30, backgroundColor: 'white', width: 200, height: 40}}
